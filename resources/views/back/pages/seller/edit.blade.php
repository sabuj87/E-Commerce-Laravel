    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="whitebg radius5 p-3 mt-3 " >
             ...
             <input class="inputCommon @error('name') errorinput @enderror " value="{{$seller->name}}"  name="name" type="text">
             ...
             <textarea style="height: 100px;" class="commontextarea"  name="description" id="editor" rows="2">{{$seller->description}}</textarea>
             @error('description')
             ...
             <label>Address</label>
             <input class="inputCommon @error('address') errorinput @enderror " value="{{$seller->address}}"  name="address" type="text">
        ...
        <input type="submit" class="theme-btn mt-3" value="Update Seller"  >
