      ...
      <div class="col-md-5">
        ...
        <div class="whitebg radius5 p-3 mt-3 " >
             ...
             <select class="commonSelect" name="parentid" id="">
              ...
              <select class="commonSelect" name="show_homepage" id="">
             ...
             <textarea style="height: 50px;" class="commontextarea" name="description" id="editor" rows="1"></textarea>
             @error('description')
        ...
        <input type="submit" class="theme-btn mt-3" value="Add category"  >
