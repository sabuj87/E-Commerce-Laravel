...
<div>
    ...
    <div class="row newproduct  p-2 mt-3
     ">
     <h4 class="mt-3 mainColorBg text-white round5 mb-3" >Trandy Products</h4>
        @foreach(App\Models\Product::orderBy('id','desc')->where('place','trandy')->take(6)->get() as $product)
